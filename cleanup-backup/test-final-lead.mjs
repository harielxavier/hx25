// Script to create a final test lead to trigger the updated onLeadCreatedWithAdmin function
...
async function createTestLead() {
  try {
    const testLead = {
      ...
      message: 'This is a final test lead created to verify the updated onLeadCreatedWithAdmin function with proper branding.',
      source: 'test_script',
      status: 'new',
    ...
    console.log('This should trigger the updated onLeadCreatedWithAdmin function.');
    console.log('Check your email for the confirmation and admin notification with proper branding.');
  } catch (error) {
