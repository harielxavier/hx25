...
import { f as auth } from "./index-B-15RnBU.js";
...
const refreshToken = () => __async(null, null, function* () {
  try {
    ...
    const response = yield axios.post("/api/auth/refresh-token", { refreshToken: refreshToken2 });
...
//# sourceMappingURL=authService-CHLZdxIs.js.map
