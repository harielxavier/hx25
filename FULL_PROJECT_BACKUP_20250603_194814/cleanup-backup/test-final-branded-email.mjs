// Script to create a final test lead to trigger the updated onLeadCreatedWithAdmin function with personalized branded emails
...
async function createTestLead() {
  try {
    const testLead = {
      firstName: 'Final',
      lastName: 'Branded Email Test',
      email: 'missiongeek@gmail.com', // Use your email to receive the test email
      phone: '555-123-4567',
      eventType: 'wedding',
      eventDate: '2026-11-15',
      message: 'This is a test lead created to verify the updated onLeadCreatedWithAdmin function with personalized branded emails that reflect your luxury black and white brand with champagne accents.',
      source: 'test_script',
      status: 'new',
    ...
    console.log('Final branded test lead created with ID:', docRef.id);
