// Script to create a final test lead to trigger the updated onLeadCreatedWithAdmin function with beautiful emails
...
async function createTestLead() {
  try {
    const testLead = {
      firstName: 'Final',
      lastName: 'Beautiful Email Test',
      email: 'missiongeek@gmail.com', // Use your email to receive the test email
      phone: '555-123-4567',
      eventType: 'wedding',
      eventDate: '2026-09-15',
      message: 'This is a final test lead created to verify the updated onLeadCreatedWithAdmin function with beautiful branded emails using public image URLs.',
      source: 'test_script',
      status: 'new',
    ...
    console.log('Final test lead created with ID:', docRef.id);
    console.log('This should trigger the onLeadCreatedWithAdmin function with beautiful branded emails.');
