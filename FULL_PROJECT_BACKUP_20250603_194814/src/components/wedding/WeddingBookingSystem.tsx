...
const WeddingBookingSystem: React.FC = () => {
  ...
  return (
    <div className="wedding-booking-container">
      ...
      <p className="booking-intro">Secure your date and start the journey to beautiful wedding memories</p>
      ...
      {step === 3 && (
        <div className="booking-step confirmation">
          ...
          <p className="next-steps">
            ...
            3. I'll send a contract and invoice for the deposit (25% to secure your date)
          </p>
