...
interface PerfectGridGalleryProps {
  images: GalleryImage[];
  className?: string;
...
const PerfectGridGallery: React.FC<PerfectGridGalleryProps> = ({
  images,
  className = '',
  featuredFirst = true,
  onImageClick
      ...
      <Gallery>
        <div className="flex flex-wrap">
          {sortedImages.map((image) => (
            <div 
              key={image.id}
              className="w-1/2 md:w-1/3 lg:w-1/4 relative overflow-hidden"
...
export default PerfectGridGallery;
