...
exports.createPlainThankYouEmailTemplate = void 0;
/**
 * Creates an enhanced HTML thank you email template for client inquiries
 ...
 * @returns HTML email template with enhanced branding
 */
const createPlainThankYouEmailTemplate = (name, email, eventType = 'wedding', eventDate, isDateAvailable) => {
    ...
    if (eventDate && isDateAvailable !== undefined) {
        if (isDateAvailable) {
            availabilityMessage = `<div style="background-color: #e0fbfc; border-left: 4px solid #ee6c4d; padding: 20px; margin: 25px 0;">
        <p style="margin: 0; line-height: 1.6; font-size: 16px;">
          <strong>Good news!</strong><br>
          I'm currently available for your ${eventType.toLowerCase()} on ${eventDate}, and I'd love to learn more about what you're envisioning.
        </p>
      </div>`;
        }
        else {
            availabilityMessage = `<div style="background-color: #e0fbfc; border-left: 4px solid #ee6c4d; padding: 20px; margin: 25px 0;">
        <p style="margin: 0; line-height: 1.6; font-size: 16px;">
          <strong>Date availability:</strong><br>
          I'm currently booked on ${eventDate}. I'd love to recommend some talented photographer colleagues who might be available. Alternatively, if your date is flexible, let me know and we can check other dates.
        </p>
      </div>`;
        }
    }
...
exports.createPlainThankYouEmailTemplate = createPlainThankYouEmailTemplate;
//# sourceMappingURL=plain-email-template.js.map