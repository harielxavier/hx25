                    ...
                    <tr>
                      ...
                      <td style="padding: 8px 12px; border: 1px solid #ddd;">
                        ...
                        ${leadData.dateAvailability ? `
                          <span style="margin-left: 10px; padding: 2px 6px; font-size: 12px; border-radius: 3px; ${
                            leadData.dateAvailability === 'Available' 
 ...
 * @returns HTML email template
 */
export const createThankYouEmailTemplate = (
  name: string,
  email: string,
