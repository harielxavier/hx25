...
const sarahMichaelGallery = {
  ...
  coverImage: '/mostuff/Amanda & Alex\'s Wedding/Amanda & Alexander\'s Wedding-07196_websize.jpg'
};

// Gallery images
const galleryImages = sarahMichaelImages.filter(img => 
  // Exclude the featured thumbnail from the main gallery
  img.id !== 'sarah-michael-featured'
);

function SarahMichaelGalleryPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[70vh] bg-black">
        ...
        <img 
          src={sarahMichaelGallery.coverImage}
          alt={`${sarahMichaelGallery.title} Wedding at ${sarahMichaelGallery.venue}`}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-20">
          ...
          <div className="flex items-center text-lg md:text-xl mb-2">
            ...
            <span>{sarahMichaelGallery.venue}, {sarahMichaelGallery.location}</span>
          </div>
        </div>
      </div>
          ...
          <>
            ...
            <div className="mb-16">
              <PhotoswipeResponsiveGallery 
                ...
                data-gallery-title={`${sarahMichaelGallery.title} Wedding at ${sarahMichaelGallery.venue}`}
              />
            </div>
            ...
            <div className="my-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                <div>
                  ...
                  <p className="text-lg mb-4">
                    What sets The Mansion on Main Street apart is its stunning architecture and versatile event spaces. The grand ballroom, adorned with crystal chandeliers and elegant decor, provided the perfect backdrop for Sarah & Michael's reception, blending classic charm with contemporary style.
                  </p>
                  <p className="text-lg mb-4">
                    The venue's beautifully landscaped grounds and outdoor ceremony space, where Sarah & Michael exchanged their vows, create a romantic atmosphere surrounded by natural beauty. The seamless transition to the cocktail hour and reception spaces allowed guests to fully enjoy the celebration in this magnificent setting.
                  </p>
                  <p className="text-lg">
                    With exceptional service and attention to detail, The Mansion on Main Street ensures that every aspect of the wedding day is flawlessly executed. From personalized menus to impeccable timing, Sarah & Michael's wedding was a testament to the venue's commitment to creating magical experiences.
                  </p>
                  <p className="mt-4">
                ...
                <div className="rounded-lg overflow-hidden shadow-xl">
                  <img 
                    src="/mostuff/Amanda & Alex's Wedding/Amanda & Alexander's Wedding-07797_websize.jpg" 
            ...
            <div className="bg-gray-100 rounded-xl p-8 md:p-12 text-center max-w-4xl mx-auto mt-16">
              ...
              <p className="text-lg mb-6">I would be honored to capture the magic of your special day with the same care and artistry shown in Sarah and Michael's gallery.</p>
...
export default SarahMichaelGalleryPage;
