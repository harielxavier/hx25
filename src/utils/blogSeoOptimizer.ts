...
const generateCallToAction = (category: string): string => {
  const ctas = [
    ...
    `<div class="cta-container">
      ...
      <p>Don't wait to reserve your booking! Our calendar fills up quickly, especially during peak seasons. Contact us now to check availability and discuss your vision.</p>
