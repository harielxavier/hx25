...
// Updated to use ES Modules syntax for better future compatibility
...
// Run the function with top-level await (ES Modules feature)
try {
  await checkAndCreateFeaturedGalleries();
