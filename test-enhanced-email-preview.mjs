...
/**
 * This script demonstrates the enhanced email templates with branding
 * It will generate sample HTML files that you can open in your browser to preview
 */
 ...
 */
const generateAdminEmail = (params) => {
...
// Generate the sample emails
const clientEmail = generateClientEmail(sampleClientData);
const adminEmail = generateAdminEmail(sampleLeadData);
...
// Write the emails to HTML files
fs.writeFileSync(path.join(outputDir, 'client-email-preview.html'), clientEmail);
fs.writeFileSync(path.join(outputDir, 'admin-email-preview.html'), adminEmail);

console.log('Email previews generated successfully!');
console.log(`Client email preview: ${path.join(outputDir, 'client-email-preview.html')}`);
console.log(`Admin email preview: ${path.join(outputDir, 'admin-email-preview.html')}`);
console.log('\nOpen these HTML files in your browser to see how the enhanced emails look.');
